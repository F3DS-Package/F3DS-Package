module class_hllc
    ...
    pure function compute_features(            &
        ...
        associate(                                &
            ...
            features(4) => s_puls               , &
            features(5) => s_mid                , &
            features(6) => c_star_left          , &
            features(7) => c_star_right           &
        )
    ...
    pure function compute_energy_flux_interface( &
        ...
        associate(                                &
            ...
            q_star_left  = c_star_left  * (lhc_e + (s_mid - lhc_u) * (lhc_rho * s_mid + lhc_p / (s_left  - lhc_u)))
            q_star_right = c_star_right * (rhc_e + (s_mid - rhc_u) * (rhc_rho * s_mid + rhc_p / (s_right - rhc_u)))

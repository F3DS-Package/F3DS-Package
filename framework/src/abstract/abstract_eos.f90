module abstract_eos
    ...
    type, public, abstract :: eos
        ...
        procedure(compute_soundspeed_interface              ), pass(self), deferred :: compute_frozen_soundspeed
    ...
    abstract interface
        ...
        pure function compute_frozen_soundspeed_interface(self, pressure, densities, volume_fruction) result(soundspeed)
            use typedef_module
            import eos
            class(eos), intent(in) :: self
            real (real_kind  ), intent(in) :: pressure
        ...
        pure function compute_wood_soundspeed_interface(self, pressure, densities, volume_fruction) result(soundspeed)
            use typedef_module
            import eos
            class(eos), intent(in) :: self
            real (real_kind  ), intent(in) :: pressure
        ...
        pure function compute_k_interface(self, pressure, densities, volume_fruction) result(k)
            use typedef_module
            import eos
            class(eos), intent(in) :: self
            real (real_kind  ), intent(in) :: pressure

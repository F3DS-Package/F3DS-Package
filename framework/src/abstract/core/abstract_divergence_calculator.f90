module abstract_divergence_calculator
    ...
    abstract interface
        ...
        pure function compute_residual_interface(self, lhc_vector, rhc_vector, lhc_position, rhc_position, face_normal_vector, face_position, face_area) result(residual)
            use typedef_module
            import divergence_calculator

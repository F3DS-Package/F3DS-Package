module weno5_js_module
    ...
    public :: reconstruct_weno5_js
    public :: reconstruct_lhc_weno5_js
    public :: reconstruct_rhc_weno5_js
    ...
    pure function reconstruct_lhc_weno5_js( &
    ...
    end function reconstruct_lhc_weno5_js

    pure function reconstruct_rhc_weno5_js( &
        primitive_values_set             , &
        face_to_cell_index        , &
        cell_positions                   , &
        face_positions                   , &
    ...
    end function reconstruct_rhc_weno5_js

    pure function reconstruct_weno5_js(  &
        primitive_values_set              , &
        ...
        lhc_primitive = reconstruct_lhc_weno5_js(      &
            primitive_values_set                       , &
            face_to_cell_index                         , &
            cell_centor_positions                      , &
            face_centor_positions                      , &
        ...
        rhc_primitive = reconstruct_rhc_weno5_js(     &
            primitive_values_set                       , &
            face_to_cell_index                         , &
            cell_centor_positions                      , &
            face_centor_positions                      , &
    ...
    end function reconstruct_weno5_js
end module weno5_js_module
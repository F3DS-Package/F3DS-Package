module abstract_configuration
    ...
    abstract interface
        ...
        subroutine get_real_interface(self, tag, value, found, default)
            use typedef_module
            import configuration
            class    (configuration), intent(inout)            :: self
        ...
        subroutine add_int_interface(self, tag, value)
            use typedef_module
            import configuration
            class    (configuration), intent(inout)            :: self
            character(len=*        ), intent(in   )            :: tag
        ...
        subroutine add_bool_interface(self, tag, value)
            use typedef_module
            import configuration
            class    (configuration), intent(inout)            :: self
            character(len=*        ), intent(in   )            :: tag
        ...
        subroutine add_char_interface(self, tag, value)
            use typedef_module
            import configuration
            class    (configuration), intent(inout)            :: self
            character(len=*        ), intent(in   )            :: tag

...
FC=gfortran
FCFLAGS=-O0 -g -pg -ffree-line-length-none -cpp -Wall -Wextra -Warray-temporaries -Wconversion -fimplicit-none -fbacktrace -fcheck=all -ffpe-trap=invalid,zero -finit-real=nan -D_DEBUG # for debug build (gfortran)-ffpe-trap=invalid,zero,underflow,overflow

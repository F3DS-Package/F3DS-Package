...
FRAMEWORK_SRCS+=$(wildcard $(FRAMEWORK_SRCDIR)/abstract/*.f90)
# Tier 2 layer ()
...
FRAMEWORK_SRCS+=$(wildcard $(FRAMEWORK_SRCDIR)/gradient_scheme/*.f90)
...
#FRAMEWORK_SRCS+=$(wildcard $(FRAMEWORK_SRCDIR)/boundary_conditions/*.f90)
# Tier 1 layer
...
FIVE_EQ_MODEL_SRCS+=$(wildcard $(FIVE_EQ_MODEL_SRCDIR)/reconstructor/*.f90)
